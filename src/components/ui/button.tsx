  ...
  "inline-flex items-center cursor-pointer justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        pink:
          "bg-[var(--color-pink)] text-white shadow-xs hover:bg-[var(--color-pink)]/90 dark:border dark:border-[#474747]",
        purple:
          "bg-[var(--color-purple)] text-white shadow-xs hover:bg-[var(--color-purple)]/90 dark:border dark:border-[#474747]",
        lime:
          "bg-[var(--color-lime)] border border-[#D5D5D6] text-black  hover:bg-[var(--color-lime)]/60  ",
        teal:
          "bg-[var(--color-teal)] text-black shadow-xs hover:bg-[var(--color-teal)]/90 dark:border dark:border-[#474747]",
      },
      size: {
        default: "h-9 px-4 py-2 has-[>svg]:px-3",
        sm: "h-8 rounded-md gap-1.5 px-3 has-[>svg]:px-2.5",
        lg: "h-10 rounded-md px-6 has-[>svg]:px-4",
        xl: "h-10 rounded-md px-6 has-[>svg]:px-4  text-base font-sans ",
        icon: "size-9",
      },
    },
    defaultVariants: {
